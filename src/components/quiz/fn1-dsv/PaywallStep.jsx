...
export default function PaywallStep({ userName, birthDate, quizResultId }) {
  ...
  useEffect(() => {
    ...
    redtrackScript.src = 'https://rdk.auralyapp.com/track.js?rtkcmpid=69414cba6ede4be6c87dba90';
    redtrackScript.async = true;

    redtrackScript.onload = () => {
      console.log('✅ RedTrack script loaded and ready for fn1-dsv funnel');
    ...
    console.log('🔄 Loading RedTrack script for fn1-dsv funnel...');
