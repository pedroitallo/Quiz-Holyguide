...
export default function PaywallStep({ userName, birthDate, quizResultId }) {
  ...
  useEffect(() => {
    ...
    redtrackScript.src = 'https://rdk.auralyapp.com/track.js?rtkcmpid=694696139a8a22274b5684d5';
    redtrackScript.async = true;

    redtrackScript.onload = () => {
      console.log('✅ RedTrack script loaded and ready for fn1-org funnel');
    ...
    console.log('🔄 Loading RedTrack script for fn1-org funnel...');
