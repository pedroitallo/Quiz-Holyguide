...
export default function LoveChallenge({ onSubmit }) {
  ...
  const challenges = [
    { value: "finding_connection", label: "Encontrar a alguien que realmente conecte conmigo", emoji: "💘" },
    { value: "keeping_love_alive", label: "Mantener el amor vivo y sentido profundamente", emoji: "🔥" },
    { value: "being_vulnerable", label: "Abrirme y ser vulnerable", emoji: "🕊️" },
    { value: "breaking_patterns", label: "Romper viejos patrones de relación", emoji: "🔄" },
    { value: "uncertain_path", label: "Inseguro(a) sobre mi camino en el amor", emoji: "🌫️" }
  ];
    ...
    <div className="text-center py-4">
      ...
      >
        <h1 className="text-purple-600 mb-6 text-xl md:text-2xl font-bold leading-tight px-4">
          ¿CUÁL ES TU MAYOR DESAFÍO AMOROSO HOY?
        </h1>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-base text-gray-700 leading-relaxed">
                        Estás en el camino correcto, y el hecho de que estés reflexionando sobre esto ya muestra cuán preparado(a) estás para el amor verdadero. Sigamos adelante.
                      </p>
                    </div>
                  </div>
                </div>
