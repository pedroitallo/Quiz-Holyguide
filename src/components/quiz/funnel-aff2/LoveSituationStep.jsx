...
{ id: "single", label: "Estoy soltera", icon: Search, description: "Buscando amor" },
{ id: "dating", label: "Estoy saliendo o hablando con alguien", icon: Users, description: "Explorando conexiones" },
{ id: "relationship_missing", label: "Estoy en una relación, pero siento que falta algo", icon: Heart, description: "Buscando plenitud" },
{ id: "happy_relationship", label: "Estoy en una relación feliz y quiero confirmar si esta es mi Alma Gemela", icon: Check, description: "Buscando confirmación" }];
          ...
          <>
                  ...
                  className="w-10 h-10 rounded-full object-cover border-2 border-purple-200" />
                        ...
                        <p className="text-base text-gray-700 leading-relaxed">
                            {userName ? <><span className="font-bold">{userName}</span>, Me alegra escuchar que las cosas están progresando en tu vida.</> : "Me alegra escuchar que las cosas están progresando en tu vida."} Las personas del signo <span className="font-bold">{zodiacSign}</span> tienden a tener un viaje romántico más profundo, y <strong>mi visión indica que estás a punto de tener una revelación transformadora!</strong>
                        </p>
                        </div>
                    </div>
                    </div>
