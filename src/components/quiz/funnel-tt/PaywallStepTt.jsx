...
export default function PaywallStepTt({ userName, birthDate, quizResultId, src }) {
  ...
  const handleCheckout = async () => {
    ...
    trackCheckout().then(() => {
      try {
        ...
        const checkoutUrl = "https://ttk.holyguide.com/click";
        ...
        window.location.href = "https://ttk.holyguide.com/click";
      }
    }).catch((error) => {
  ...
  return (
    <div className="text-center py-8">
      {/* Garantir que o script de tracking esteja presente no paywall do funnel-tt */}
