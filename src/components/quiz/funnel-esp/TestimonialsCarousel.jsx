    ...
    <div className="text-center py-8">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-left">
              <p className="text-base text-gray-700 leading-relaxed">
                ¡Hola! Soy Master Aura y en unos minutos descubriremos el rostro de tu alma gemela! ✨ Solo Este Año, <strong>He Conectado Más De 9,200 Almas Gemelas</strong> A Través De Mis Dibujos Y Revelaciones 👇🏼
              </p>
            </div>
          </div>
        </div>
      ...
      <motion.div
        ...
        <p className="text-gray-700 text-lg mb-6 leading-relaxed max-w-md mx-auto font-semibold">
          ¿Estás Lista/o Para Recibir El Dibujo De Tu Alma Gemela? 👇🏼
        </p>
