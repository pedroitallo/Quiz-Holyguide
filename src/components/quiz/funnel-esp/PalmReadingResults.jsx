        ...
        <div className="flex items-start gap-3">
            ...
            <div className="text-left">
                <p className="text-base text-gray-700 leading-relaxed">
                    {userName ? <>Wow {userName}...</> : "Wow..."} <strong>¡Los Resultados De Tu Carta Natal Fueron Sorprendentes!</strong> Te enviaré un breve audio hablando un poco sobre tu destino amoroso
                </p>
            </div>
        </div>
    </motion.div>
    ...
    >
        <div className="flex items-start gap-3">
            ...
            <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-sm text-gray-500 ml-2">Master Aura está grabando un audio...</span>
            </div>
        </div>
    </motion.div>
);
            ...
            <AnimatePresence>
                {showButton && (
                    ...
                    >
                        ...
                        >
                            Ir a la Revelación Completa Ahora
                        </Button>
                    </motion.div>
                )}
            </AnimatePresence>
