...
const BUTTON_DELAY_SECONDS = 120;
        ...
        >
          ...
          {!buttonEnabled && (
            <div className="w-full flex justify-center mb-6">
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl py-4 px-6 max-w-md">
                <div className="flex items-center justify-center gap-3 mb-2">
                  <Lock className="w-5 h-5 text-yellow-600" />
                  <p className="text-sm font-semibold text-yellow-800">
                    Watch the video to unlock your offer
                  </p>
                </div>
          ...
          <button
            ...
            className={`w-full font-bold py-5 px-6 rounded-xl text-lg md:text-xl transition-all duration-300 ${
              buttonEnabled
          ...
          >
            {buttonEnabled ? (
              ...
              <span className="flex items-center justify-center gap-2">
                ...
                Watch video to unlock ({formatTime(timeLeft)})
              </span>
            )}
          </button>
          ...
          <button
            onClick={handleCheckout}
            disabled={!buttonEnabled}
            className={`w-full mt-4 font-bold py-5 px-6 rounded-xl text-lg md:text-xl transition-all duration-300 ${
              buttonEnabled
                ? "bg-green-500 hover:bg-green-600 text-white cursor-pointer"
                : "bg-gray-300 text-gray-500 cursor-not-allowed"
            }`}
