...
export default function PaywallStep({ userName, birthDate, quizResultId }) {
  ...
  useEffect(() => {
    ...
    redtrackScript.src = 'https://rdk.auralyapp.com/track.js?rtkcmpid=6968d2ed204268d287472ac6';
    redtrackScript.async = true;

    redtrackScript.onload = () => {
      console.log('✅ RedTrack script loaded and ready for fn2-tiktok');
    ...
    console.log('🔄 Loading RedTrack script for fn2-tiktok...');
