...
import IntroStep from "../components/quiz/funnel-star5/IntroStep";
...
export default function FunnelStar5Page() {
  ...
  useEffect(() => {
    ...
    if (currentStep <= stepNames.length) {
      trackStepView('funnel-star5', stepNames[currentStep - 1]);
    }
  }, [currentStep]);
