...
import IntroStep from "../components/quiz/funnel-star4/IntroStep";
...
export default function FunnelStar4Page() {
  ...
  useEffect(() => {
    ...
    if (currentStep <= stepNames.length) {
      trackStepView('funnel-star4', stepNames[currentStep - 1]);
    }
  }, [currentStep]);
