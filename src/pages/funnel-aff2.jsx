...
import InitiateQuiz from "../components/quiz/funnel-aff2/InitiateQuiz";
import TestimonialsCarousel from "../components/quiz/funnel-aff2/TestimonialsCarousel";
import BirthDateWithZodiac from "../components/quiz/funnel-aff2/BirthDateWithZodiac";
import LoveSituationStep from "../components/quiz/funnel-aff2/LoveSituationStep";
import IdealPartnerQualities from "../components/quiz/funnel-aff2/IdealPartnerQualities";
import PartnerPreference from "../components/quiz/funnel-aff2/PartnerPreference";
import BirthChartResults from "../components/quiz/funnel-aff2/BirthChartResults";
import LoveChallenge from "../components/quiz/funnel-aff2/LoveChallenge";
import LoveDesire from "../components/quiz/funnel-aff2/LoveDesire";
import SoulmateConnection from "../components/quiz/funnel-aff2/SoulmateConnection";
import LoveLanguage from "../components/quiz/funnel-aff2/LoveLanguage";
import RelationshipEnergy from "../components/quiz/funnel-aff2/RelationshipEnergy";
import FutureScenario from "../components/quiz/funnel-aff2/FutureScenario";
import SocialProof from "../components/quiz/funnel-aff2/SocialProof";
import SoulmateDrawingLoading from "../components/quiz/funnel-aff2/SoulmateDrawingLoading";
import PaywallStep from "../components/quiz/funnel-aff2/PaywallStep";
import ThankYouStep from "../components/quiz/shared/ThankYouStep";

export default function FunnelAff2Page() {
  ...
  useEffect(() => {
    if (currentStep < 17) {
      ...
      localStorage.setItem('holymind_quiz_state_funnel_aff2', JSON.stringify(stateToSave));
  ...
  useEffect(() => {
    const initializeQuizSession = async () => {
      const savedStateJSON = localStorage.getItem('holymind_quiz_state_funnel_aff2');
      if (savedStateJSON) {
        try {
  ...
  useEffect(() => {
    ...
    if (currentStep <= stepNames.length) {
      trackStepView('funnel-aff2', stepNames[currentStep - 1]);
    }
  }, [currentStep]);
