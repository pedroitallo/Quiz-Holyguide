...
import PaywallStep from "../components/quiz/funnel-trialvsl/PaywallStep";
...
export default function FunnelTrialVSLPage() {
  ...
  useEffect(() => {
    ...
    if (currentStep <= stepNames.length) {
      trackStepView('funnel-trialvsl', stepNames[currentStep - 1]);
    }
  }, [currentStep]);
